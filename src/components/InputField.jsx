    ...
    <div className={`space-y-sm ${className}`}>
      ...
      <div className="group relative">
        ...
        <input
          ...
          className="block h-12 w-full rounded-lg border border-outline-variant bg-surface-container-low py-3 pl-12 pr-4 font-body-md text-body-md text-on-surface placeholder:text-outline transition-all duration-200 focus:border-primary-container focus:outline-none focus:ring-2 focus:ring-primary-container/25 dark:border-[#654746] dark:bg-[#301f1e] dark:text-[#ffedeb] dark:placeholder:text-[#bfa3a1]"
          {...props}
        />
      </div>
      {error ? (
